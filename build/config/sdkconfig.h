...
#define CONFIG_BT_LE_SCAN_DUPL_TYPE_DATA_DEVICE 1
#define CONFIG_BT_LE_SCAN_DUPL_TYPE 2
...
#define CONFIG_BLE_MESH_TRACE_LEVEL_VERBOSE 1
#define CONFIG_BLE_MESH_STACK_TRACE_LEVEL 5
